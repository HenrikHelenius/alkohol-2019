...
(function() {
	...
	CompareBasket.prototype._createItemPreview = function(item) {
		...
		removeCtrl.innerHTML = '<i class="fa fa-remove alko-icon alko-icon-check"></i><span class="action__text action__text--invisible">Remove product</span>';
		removeCtrl.addEventListener('click', function() {
			self.remove(item);
		});
		
		var rankEl = item.querySelector('.rank').cloneNode(true);

		preview.appendChild(rankEl);
